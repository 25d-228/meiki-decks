...
python meiki_decks.py build-bundle --bundle zh-Hans-CN-complete
python meiki_decks.py build-bundle --bundle all-current-v0.3.0
```
...
audio/zh-Hans-CN-foundation-2/zh-f2-001.mp3 through zh-f2-200.mp3
dist/meiki-zh-hans-cn-foundation-2-v0.1.0.meiki
dist/README-zh-Hans-CN-foundation-2.txt

audio/zh-Hans-CN-intermediate-1/zh-i1-001.mp3 through zh-i1-250.mp3
dist/meiki-zh-hans-cn-intermediate-1-v0.1.0.meiki
dist/README-zh-Hans-CN-intermediate-1.txt

audio/zh-Hans-CN-upper-intermediate-1/zh-u1-001.mp3 through zh-u1-250.mp3
...
dist/meiki-zh-hans-cn-complete-v0.1.0.meiki
dist/README-zh-Hans-CN-complete.txt

dist/meiki-all-current-v0.3.0.meiki
dist/README-all-current-v0.3.0.txt
```
