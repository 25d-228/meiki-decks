...
DECKS = {
    ...
    "ko-KR-advanced-1": {
        "cards_path": ROOT / "cards" / "ko-KR-advanced-1.json",
        "archive_path": ROOT / "dist" / "meiki-ko-kr-advanced-1-v0.1.0.meiki",
        "handoff_path": ROOT / "dist" / "README-ko-KR-advanced-1.txt",
        "card_prefix": "ko-a1-",
        "count": 300,
        "deck_id": "meiki-ko-kr-advanced-1",
        "name": "Korean Advanced 1",
        "description": "300 advanced Korean audio-guided typed-cloze cards bridging TOPIK 5–6 and functional contemporary usage.",
        "language_tag": "ko-KR",
        "voice": "Sohee",
        "tts_language": "Korean",
    },
    ...
    "zh-Hans-CN-foundation-2": {
        "cards_path": ROOT / "cards" / "zh-Hans-CN-foundation-2.json",
        "archive_path": ROOT / "dist" / "meiki-zh-hans-cn-foundation-2-v0.1.0.meiki",
        "handoff_path": ROOT / "dist" / "README-zh-Hans-CN-foundation-2.txt",
        "card_prefix": "zh-f2-",
        "count": 200,
        "deck_id": "meiki-zh-hans-cn-foundation-2",
        "name": "Mandarin Foundation 2",
        "description": "200 strong-beginner Mandarin audio-guided typed-cloze cards covering practical Band 2 usage.",
        "language_tag": "zh-Hans-CN",
        "voice": "Vivian",
        "tts_language": "Chinese",
        "requires_reading": True,
    },
    "zh-Hans-CN-intermediate-1": {
        "cards_path": ROOT / "cards" / "zh-Hans-CN-intermediate-1.json",
        "archive_path": ROOT / "dist" / "meiki-zh-hans-cn-intermediate-1-v0.1.0.meiki",
        "handoff_path": ROOT / "dist" / "README-zh-Hans-CN-intermediate-1.txt",
        "card_prefix": "zh-i1-",
        "count": 250,
        "deck_id": "meiki-zh-hans-cn-intermediate-1",
        "name": "Mandarin Intermediate 1",
        "description": "250 functional-intermediate Mandarin audio-guided typed-cloze cards covering Bands 3–4 usage.",
        "language_tag": "zh-Hans-CN",
        "voice": "Vivian",
        "tts_language": "Chinese",
        "requires_reading": True,
    },
    "zh-Hans-CN-upper-intermediate-1": {
        "cards_path": ROOT / "cards" / "zh-Hans-CN-upper-intermediate-1.json",
        "archive_path": ROOT / "dist" / "meiki-zh-hans-cn-upper-intermediate-1-v0.1.0.meiki",
        "handoff_path": ROOT / "dist" / "README-zh-Hans-CN-upper-intermediate-1.txt",
        "card_prefix": "zh-u1-",
        "count": 250,
        "deck_id": "meiki-zh-hans-cn-upper-intermediate-1",
        "name": "Mandarin Upper-Intermediate 1",
        "description": "250 upper-intermediate Mandarin audio-guided typed-cloze cards covering practical Bands 5–6 usage.",
        "language_tag": "zh-Hans-CN",
        "voice": "Vivian",
        "tts_language": "Chinese",
        "requires_reading": True,
    },
    "zh-Hans-CN-advanced-1": {
        "cards_path": ROOT / "cards" / "zh-Hans-CN-advanced-1.json",
        "archive_path": ROOT / "dist" / "meiki-zh-hans-cn-advanced-1-v0.1.0.meiki",
        "handoff_path": ROOT / "dist" / "README-zh-Hans-CN-advanced-1.txt",
        "card_prefix": "zh-a1-",
        "count": 300,
        "deck_id": "meiki-zh-hans-cn-advanced-1",
        "name": "Mandarin Advanced 1",
        "description": "300 advanced Mandarin audio-guided typed-cloze cards bridging Bands 7–9 and functional contemporary usage.",
        "language_tag": "zh-Hans-CN",
        "voice": "Vivian",
        "tts_language": "Chinese",
        "requires_reading": True,
...
BUNDLES = {
    ...
    "zh-Hans-CN-complete": {
        "archive_path": ROOT / "dist" / "meiki-zh-hans-cn-complete-v0.1.0.meiki",
        "handoff_path": ROOT / "dist" / "README-zh-Hans-CN-complete.txt",
        "decks": (
            ("zh-Hans-CN-foundation-1", "Mandarin 01 — Foundation 1"),
            ("zh-Hans-CN-foundation-2", "Mandarin 02 — Foundation 2"),
            ("zh-Hans-CN-intermediate-1", "Mandarin 03 — Intermediate 1"),
            (
                "zh-Hans-CN-upper-intermediate-1",
                "Mandarin 04 — Upper-Intermediate 1",
            ),
            ("zh-Hans-CN-advanced-1", "Mandarin 05 — Advanced 1"),
        ),
    },
    "all-current": {
    ...
    "all-current-v0.3.0": {
        "archive_path": ROOT / "dist" / "meiki-all-current-v0.3.0.meiki",
        "handoff_path": ROOT / "dist" / "README-all-current-v0.3.0.txt",
        "decks": (
            ("ja-JP-foundation-1", "Japanese 01 — Foundation 1"),
            ("ja-JP-foundation-2", "Japanese 02 — Foundation 2"),
            ("ja-JP-elementary-1", "Japanese 03 — Elementary 1"),
